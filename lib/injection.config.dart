...
import 'package:ricky_n_morty_aap/characters/presentation/bloc/character_bloc.dart'
    as _i7;
import 'package:ricky_n_morty_aap/network/network_module.dart' as _i8;
...
_i1.GetIt init(
  ...
  gh.factory<_i5.CharacterRepository>(
      () => _i5.CharactersRepositoryImpl(gh<_i4.CharacterService>()));
  gh.factory<_i6.CharactersInteractor>(
      () => _i6.CharactersInteractorImpl(gh<_i5.CharacterRepository>()));
  gh.factory<_i7.CharacterBloc>(
      () => _i7.CharacterBloc(gh<_i6.CharactersInteractor>()));
  return getIt;
}
